...
class AmosUserDashboards extends \lispa\amos\core\record\AmosRecordAudit
{
    ...
    {
        return $this->hasMany(\lispa\amos\dashboard\models\AmosUserDashboardsWidgetMm::className(), ['amos_user_dashboards_id' => 'id']);
    }
    ...
    public function getAmosWidgetsClassnames($allModules = false)
    {
        ...
        if($allModules){
            $query = \lispa\amos\dashboard\models\AmosWidgets::find()
